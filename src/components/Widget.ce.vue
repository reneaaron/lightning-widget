    ...
    <div class="back">
      <a href="javascript:void(0)" @click="back()" v-if="step != 'start' && step != 'error' && step != 'thankyou'">
          ...
          <g clip-path="url(#clip0_27_452)">
            <path class="inherit-textcolor" d="M13.8994 6.99833e-10L4.70703 9.19239C4.3165 9.58291 4.3165 10.2161 4.70703 10.6066L13.8994 19.799" stroke="white" stroke-width="2" stroke-linecap="round"/>
          </g>
          <defs>
    ...
    <div class="card" v-bind:style="backgroundImageStyle">
      <Transition name="fade" mode="out-in">
        ...
        <div v-else-if="step == 'note'">
            ...
            <textarea id="comment" class="mb-1" name="comment" placeholder="Enter your note" rows="4" v-model="comment"></textarea>
